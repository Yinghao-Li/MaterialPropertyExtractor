...
def extract(args: Arguments):
    ...
    annotator = Annotator(keyword_paths=args.keyword_path) \
        .load_bert_for_material_name(model_dir=args.material_name_model_dir) \
        .load_bert_for_property(model_dir=args.property_model_dir)
    ...
    for file_path in path_list:
        ...
        try:
            ...
            article, _ = annotator.annotate_property_bert(article)
