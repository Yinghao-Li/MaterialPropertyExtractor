...
@dataclass
class BertNERConfig(BertNERArguments):
    """
    ...
    def from_args(self, args: BertNERArguments) -> "BertNERConfig":
        """
    ...
    def save(self, file_dir: str) -> "BertNERConfig":
        """
    ...
    def load(self, file_dir: str) -> "BertNERConfig":
        """
    ...
    def from_config(self, config) -> "BertNERConfig":
        """
